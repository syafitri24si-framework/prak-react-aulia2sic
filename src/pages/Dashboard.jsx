...
export default function Dashboard() {
  ...
  // 🔥 DATA DUMMY untuk testing (tanpa localStorage)
  const user = {
    username: "Aulia Syafitri",
    email: "aulia@example.com",
    image: "/img/strawberryAul.jpg"
  };

  // 🔥 logout (opsional, kalau tetap mau ada fungsi logout)
  const handleLogout = () => {
    // Kosongkan saja atau arahkan ke halaman kosong
    alert("Logout - tapi karena mode demo, tidak ada perubahan");
  };
